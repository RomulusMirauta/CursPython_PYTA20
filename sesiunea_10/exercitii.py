...
#
# Yes, "overriding method" in English translates to "suprascriere metodă" in Romanian. This refers to the concept in object-oriented programming where a subclass provides a specific
# implementation of a method that is already defined in its superclass. The method in the subclass overrides the one in the superclass.
